...
# Alternative:
#def valueInRangeSlow(img, lower, upper):
#    for x in range(img.shape[o]):
#        for y in range(img.shape[1]):
#            img[x,y] > lower and img[x,y] < upper
...
# Alternative:
#def valueInRangeFast(img, lower, upper):
...
#tic = time.time()     # speichert die Startzeit
#for t in range(100):  # Iteriert 100 mal
#    valueInRangeSlow(img, 99, 200) 
#toc = time.time()     # speichert die Endzeit
#print('Schleife:', toc-tic)

#tic = time.time()     # speichert die Startzeit
#for t in range(100):  # Iteriert 100 mal
#    valueInRangeFast(img, 99, 200) 
#toc = time.time()     # speichert die Endzeit
#print('Schleife:', toc-tic)