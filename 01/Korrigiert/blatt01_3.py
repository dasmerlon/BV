...
"""
#mandrill_nose = np.array(mandrill[325:450, 150:340]) #Alternative
mandrill_nose = mandrill[340:450, 150:340]
plt.figure(2)  # erstellt ein neues Bild, das erste Bild ist 1
...
"""
mandrill_black_pixel = np.copy(mandrill) # erzeugt eine deepcopy des Bildes
mandrill_black_pixel[200,200] = 0     # Färbt den Pixel an (200,200) schwarz
plt.figure(3)
plt.imshow(mandrill_black_pixel, cmap = 'gray') # Pixel kaum erkennbar (zoomen)
...
mandrill_black_eyes[30:100, 100:400] = 0  # Färbt den Bereich der Augen schwarz
plt.figure(4)
